...
class ExampleAPublicDemoTests(unittest.TestCase):
    ...
    def test_artifacts_and_dashboard_are_created(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("Advance Year [R]", dashboard_html)
            ...
            self.assertIn("Choose an insurance future", public_html)
            self.assertIn("Open admin lattice view", public_html)
            ...
            self.assertIn("Advance Year [R]", public_html)
            ...
            self.assertIn("hidden seeded stochastic scenario path with autocorrelation", public_html)
